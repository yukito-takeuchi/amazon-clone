...
BEGIN
  ...
  -- Get default address
  SELECT id INTO v_address_id FROM addresses WHERE user_id = v_user_id AND is_default = true;
  ...
  SELECT 1, id, 1, price, name FROM products WHERE id = 1;
  ...
  INSERT INTO order_items (order_id, product_id, quantity, price, product_name)
  SELECT 2, id, 1, price, name FROM products WHERE id = 41;
  ...
  INSERT INTO order_items (order_id, product_id, quantity, price, product_name)
  SELECT 3, id, 1, price, name FROM products WHERE id = 31;
  ...
  INSERT INTO order_items (order_id, product_id, quantity, price, product_name)
  SELECT 4, id, 1, price, name FROM products WHERE id = 81;
  ...
  INSERT INTO order_items (order_id, product_id, quantity, price, product_name)
  SELECT 5, id, 2, price, name FROM products WHERE id = 5;
  INSERT INTO order_items (order_id, product_id, quantity, price, product_name)
  SELECT 5, id, 1, price, name FROM products WHERE id = 10;
